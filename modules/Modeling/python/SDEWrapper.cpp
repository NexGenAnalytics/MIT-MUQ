...
void muq::Modeling::PythonBindings::SDEWrapper(py::module &m) {
  ...
  py::class_<LinearSDE, std::shared_ptr<LinearSDE> >(m, "LinearSDE")
    ...
    .def("EvolveDistribution", (std::pair<Eigen::VectorXd, Eigen::MatrixXd> (LinearSDE::*)(std::pair<py::EigenDRef<Eigen::VectorXd>,py::EigenDRef<Eigen::MatrixXd>> const&, double) const) &LinearSDE::EvolveDistribution)
    .def("EvolveDistribution", (std::pair<Eigen::VectorXd, Eigen::MatrixXd> (LinearSDE::*)(py::EigenDRef<Eigen::VectorXd> const&, py::EigenDRef<Eigen::MatrixXd> const&, double) const) &LinearSDE::EvolveDistribution)
